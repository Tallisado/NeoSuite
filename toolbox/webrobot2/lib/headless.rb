...
require File.join(File.dirname(__FILE__), "/headless/cli_util")
require 'fileutils'
...
class Headless
  ...
  def initialize(options = {})
    ...
    CliUtil.ensure_application_exists!('vncserver', 'vncserver not found on your system')
