...
describe "PPM Settings - Phone Dialog", :local => true do
	...
	it "should drag and drop all button types to the main button screen and then delete" do		
		...
		@selenium.verify_text_from_element(:id, 'PhoneEditorMessageHelp-innerCt', "Click to edit the default label in place\nDouble click to edit the configuration\nIf there is a on the button then it is not configured.");	
	...
	it "should drag and drop all button types to the EXPANSION1 screen and then delete" do
